...
all: binary/visquacompress debian/usr/bin/visquacompress
...
binary/visquacompress: $(OBJECTS) src/client_linux.cpp
	$(CPP) -o binary/visquacompress src/client_linux.cpp $(OBJECTS) $(INCLUDES) $(LIBS_VISQUA) -static $(LINK)
